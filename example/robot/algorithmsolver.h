...
private:
    ...
    QPair<QPair<int, int>, int> getChain(QVector<QPair<QPair<int, int>, int> > path,
                                         QVector<QPair<QPair<int, int>, int> > chains);
    bool isCycle(QPair<int, int> chain, QVector<QPair<QPair<int, int>, int> > path);
